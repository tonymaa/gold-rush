package cn.wz.goldRush.utils;

import cn.wz.goldRush.enums.ResponseCodeEnums;
import lombok.Data;
...
public class ResponseInfo<T> {
    ...
    public static <T> ResponseInfo<T> fail(Object message) {
     ...
     */
    public ResponseInfo(T data, Object msg) {
        this.data = data;
        this.code = ResponseCodeEnums.SUCCESS.getCode();
        this.message = msg;
    }
